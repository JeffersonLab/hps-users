...
public class MyDataTrackerHitDriver extends Driver {
    ...
    // Clusterer
    private MyStripMaker stripClusterer;
    ...
    public void detectorChanged(Detector detector) {
        ...
        System.out.println("creating stripClusteringAlgo");
        MyNearestNeighborRMSClusterer stripClusteringAlgo = new MyNearestNeighborRMSClusterer();
        ...
        stripClusterer = new MyStripMaker(stripSim, stripClusteringAlgo);
