...
public class TestLineFit {
    ...
    public static void main(String[] args) throws Exception {
        ...
        double[] SIGS = {0.010, 0.000};     //  detector resolutions in mm
        ...
        aida.saveAs("TestLineFitHps.aida");
    }
...
//         GENER_EVT B   7.09767174E-03  7.03085661E-02   1.0000000
        ...
        par[0] = 25. * (2. * ran.nextDouble() - 1.);  //x
        par[1] = 60. * (2. * ran.nextDouble() - 1.);  //y
        par[2] = (par[0] - 25. * (2. * ran.nextDouble() - 1.)) / 500.; //dxdz
        par[3] = (par[1] - 60. * (2. * ran.nextDouble() - 1.)) / 500.; //dydz
